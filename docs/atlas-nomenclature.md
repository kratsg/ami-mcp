...
## Logical Dataset Names (LDNs)

AMI identifies all datasets via **Logical Dataset Names (LDNs)**. For centrally
produced ATLAS data the project field doubles as the Rucio scope (e.g.
`mc20_13TeV`, `data18_13TeV`).
...
## Scopes and AMI catalogs

| Scope pattern                     | AMI catalog           | Description                     |
| --------------------------------- | --------------------- | ------------------------------- |
| `mc16_13TeV`                      | `mc15_001:production` | Run-2 MC, 13 TeV (original)     |
| `mc20_13TeV`                      | `mc15_001:production` | Run-2 MC, 13 TeV (reprocessing) |
| `mc21_13p6TeV`                    | `mc21_001:production` | Run-3 MC pilot, 13.6 TeV        |
| `mc23_13p6TeV`                    | `mc23_001:production` | Run-3 MC, 13.6 TeV              |
...
!!! note
    ...
    mc16 and mc20 evgen datasets live in the `mc15_001:production` AMI catalog
    because they were generated with mc15-era job options.
